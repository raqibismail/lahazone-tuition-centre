...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            $sql = "SELECT * FROM student WHERE STUD_ID = '".$_GET['id']."'";
            ...
            echo '<th>STUDENT FEE</th>';
            echo '<th>STUDENT DATE</th>';
            echo '</tr>';

            echo '<form action="admin_process/studbillsadd.php" method="post">';
            // Fetch the rows one by one
            while ($row = mysqli_fetch_assoc($result)) {
                echo '<tr>';
                echo '<td><input class="form-control" type="txt" name="studentid" readonly value="'. $row['STUD_ID'] .'"></td>';
                echo '<td><input class="form-control" type="txt" name="studentname" readonly value="'. $row['STUD_NAME'] .'"></td>';
                echo '<td><input class="form-control" type="text" name="fee"></td>';
                echo '<td><input class="form-control" type="date" name="date"></td>';
                echo '</tr>';
            }
            echo '</table>';
            echo '<div class="text-center"><input class="btn btn-primary" type="submit" value="Add Bils"></div>';
            echo '</form>';
