...
<body>
    ...
    <div class="container">
        ...
        <?php
            ...
            echo '<table class="table table-bordered text-center text-dark">';
            echo '<tr>';
            ...
            echo '</tr>';
                ...
                echo '<tr>';
                echo '<form action="admin_process/studcourseadd.php" method="post">';
                echo '<td><input type="text" class="form-control" name="courseid" placeholder="Enter Course ID"></td>';
                echo '<td><input type="text" class="form-control" name="coursename" placeholder="Enter Course Name"></td>';
                echo '</tr>';

            echo '</table>';
            echo '<div class="text-center">';
                echo '<td><input type="submit" class="btn btn-primary" name="submit"></td>';
            echo '</div>';
            echo '</form>';
        ?>
        </div>
