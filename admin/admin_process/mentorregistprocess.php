<?php
    ...
    $sql = "INSERT INTO staff (STAFF_ID, STAFF_PASS, STAFF_NAME, STAFF_IC, STAFF_PHONE, STAFF_ADDRESS, STAFF_EMAIL, COURSE_ID)
    VALUES ('$username','$password','$name','$icnumber','$phone','$address', '$email', '$tcourse')";
    ...
    else
    {
        ...
        echo '<script>window.location = "../mentorlist.php";</script>';
    }
