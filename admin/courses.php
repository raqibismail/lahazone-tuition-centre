    ...
    <div class="container">
        ...
        <form>
            <div class="form-group">
                <input type="text" class="form-control" id="search" onkeyup="searchStudent()" placeholder="Search Courses by ID">
            </div>
        </form>
        ...
        <div class="d-flex justify-content-center" >
            <a href="courseadd.php" class="btn btn-primary mx-auto" style="color: white; font-weight: 500;">Add Course</a>
        </div>
