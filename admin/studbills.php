    ...
    <div class="container">
        ...
        <?php
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $sql2 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM payment WHERE PAY_ID = '".$row['PAY_ID']."'"));
            ?>
            <tr>
                <td><?php echo $row['PAY_ID']?></td>
                <td><?php echo $row['STUD_ID']?></td>
                <td><?php echo $sql['STUD_NAME']?></td>
                <td><?php echo $sql2['PAY_FEE']?></td>
                <td><?php echo $sql2['PAY_DATE']?></td>
                <td><?php echo $sql2['PAY_STATUS']?></td>
                <td><a href="admin_process/studbillsdelete.php?id=<?php echo $sql2['PAY_ID'] ?>">Delete</a></td>
            </tr>
            <?php
            }
            ?>
