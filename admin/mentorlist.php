   ...
   <div class="container-fluid p-0">
    ...
    <div class="container table-responsive" style="overflow-x: auto;">
        ...
        <form>
            <div class="form-group">
                <input type="text" class="form-control" id="search" onkeyup="searchMentor()" placeholder="Search mentor by ID">
            </div>
        </form>
        <div id="mentor-table">
    <?php
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td>RM' . $row['STAFF_SALARY'] . '</td>';
            echo '<td>' . $row['STAFF_TYPE'] . '</td>';
            echo '<td>' . $row['COURSE_ID'] . '</td>';
            echo '<td>';
            echo "<a href='admin_process/mentorlistupdate.php?id=" . $row['STAFF_ID'] . " '>Edit</a><br>";
            echo "<a href='admin_process/mentorlistdelete.php?id=". $row['STAFF_ID'] ." '>Delete</a>";
            echo '</td>';
            echo '</tr>';
        }
    ...
    <script>
            function searchMentor() {
                            // Get the input value
            var input, filter, mentorTable, tr, td, i, txtValue;
            input = document.getElementById("search");
            filter = input.value.toUpperCase();
            mentorTable = document.getElementById("mentor-table");
            tr = mentorTable.getElementsByTagName("tr");
    ...
    <br>
    <div class="text-center" >
        <a href="mentorregist.php" class="btn btn-primary mx-auto" style="color: white; font-weight: 500;">Register Mentor</a>
    </div>
