...
<body>
    ...
    <div class="container">
        ...
        <div class="text-center">
            ...
            <a href="../admin/adminpage.php" class="btn btn-primary py-2 px-4  d-block login">Admin</a><br>
            <a href="../mentor/mentorpage.php" class="btn btn-primary py-2 px-4  d-block login">Mentor</a><br>
        </div>       
    </div>
    <!-- Body End -->
