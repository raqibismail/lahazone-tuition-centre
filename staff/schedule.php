...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    <a href="staffpage.php" class="nav-item nav-link active">Profile</a>
    ...
    <?php
        ...
        $query = "SELECT * FROM schedule WHERE STAFF_ID= '" . $_SESSION[''] . "'";
    ...
    <div class="container mt-5">    
        <table class="table table-bordered text-center ">
            ...
            <tr>
                ...
                <td><?php echo $row['CLASS_ID'] . " - " . $row2['CLASS_NAME']?></td>
                <td><a href="<?php echo $row['CLASS_ATTAND'] ?>"><?php echo $row['CLASS_ATTAND'] ?></a></td>
                <td><?php echo $row['CLASS_DATE'] ?></td>
                <td>
                    <a href='staff_process/scheduledelete.php?id=<?php echo $row['SCH_ID'] ?>'>Delete</a>
                </td>
            </tr>
            <?php } ?>
            <!-- Output an empty row for inserting new data -->
            <tr>
                <form action='staff_process/scheduleinsert.php' method='post'>
                <td width=15% >
                    <input class="form-control" type='text' name='course_id' readonly value=<?php echo $_SESSION['stafftcourse'] ?>>
                </td>
                <td width=23%>
