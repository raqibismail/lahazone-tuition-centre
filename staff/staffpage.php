                ...
                <div class="col-lg-8">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td><?php echo $_SESSION['staffname'] ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td><?php echo $_SESSION['stafftype'] ?></td>
                        </tr>
                        <tr>
                            <th width="30%">Teaching Course</th>
                            <td width="2%">:</td>
                            <td><?php echo $_SESSION['stafftcourse'] ?></td>
                        </tr>
                        <tr>
                            <th width="30%">Phone Number</th>
                            <td width="2%">:</td>
                            <td><?php echo $_SESSION['staffphone'] ?></td>
                        </tr>
                        <tr>
                            <th width="30%">Email</th>
                            <td width="2%">:</td>
                            <td><?php echo $_SESSION['staffemail'] ?></td>
                        </tr>
                        <tr>
                            <th width="30%">Address</th>
                            <td width="2%">:</td>
                            <td><?php echo $_SESSION['staffaddress'] ?></td>
                        </tr>
                        </table>
                        <div class="d-flex justify-content-center" >
                        <a href="staffpageupdate.php" class="btn btn-primary mx-auto" style="color: white; font-weight: 500;">Update</a>
                        </div>
                    </div>
                    </div>
                </div>
