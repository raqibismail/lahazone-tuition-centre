...
<div class="container-fluid p-0">
    ...
    <div class="container">
        ...
        <div class="text-center">
            ...
            <a href="student/studentregist.php" class="btn btn-primary py-2 px-4 d-none d-block">Student</a><br>
            <a href="staff/staffregist.php" class="btn btn-primary py-2 px-4 d-none d-block">Staff</a>
        </div>       
    </div>
    <!-- Body End -->
