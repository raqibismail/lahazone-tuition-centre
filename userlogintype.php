...
<div class="container-fluid p-0">
    ...
    <div class="container">
        ...
        <div class="text-center">
            <p class="text-black"> Please select one from the choices below:</p>
            <a href="student/studentlogin.php" class="btn btn-primary py-2 px-4 d-block">Student</a><br>
            <a href="parent/parentlogin.php" class="btn btn-primary py-2 px-4 d-block">Parent</a><br>
            <a href="staff/stafflogin.php" class="btn btn-primary py-2 px-4 d-block">Staff</a>
        </div>       
    </div>
    <!-- Body End -->
